...
def start_powerfactory(file):
    ...
    elif (config.detection_methods or config.detection_application) and (config.sim_setting == 'ERIGrid_phase_1' or config.sim_setting == 'ERIGrid_phase_2' or config.pf_file in config.pf_file_dict.values()):
