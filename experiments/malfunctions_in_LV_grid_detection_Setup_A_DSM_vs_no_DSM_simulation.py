        ...
        if learning_config['data_source'] == 'real_world':
            if plot_V_or_P == 'V':
                plotting_variables = {'B2': 'Vrms ph-n AN Avg', 'A1': 'Vrms ph-n AN Avg',
                                      'B1': 'Vrms ph-n AN Avg', 'C1': 'Vrms ph-n L1N Avg', 'B2_num': 4, 'A1_num': 4,
                                      'B1_num': 4, 'C1_num': 4}  # see dictionary above
            else:
                plotting_variables = {'B2': 'Wirkleistung Total Avg', 'A1': 'Wirkleistung Total Avg',
                                      'B1': 'Wirkleistung Total Avg', 'C1': 'Wirkleistung Total Avg', 'B2_num': 248,
                                      'A1_num': 296, 'B1_num': 280, 'C1_num': 296}  # see dictionary above
        else:
            if plot_V_or_P == 'V':
                plotting_variables = {'B2': 'Vrms ph-n AN Avg', 'A1': 'Vrms ph-n AN Avg',
