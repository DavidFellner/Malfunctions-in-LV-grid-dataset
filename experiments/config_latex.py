...
learning_config = {
    ...
    "dataset": "malfunctions_in_LV_grid_dataset_7day_200k",
    "type": "PV",
...
percentage = {'PV': 0,
              'EV': 25, 'BESS': 0,
              'HP': 0}  # percentage of busses with active PVs (PV proliferation), EV charging stations etc...
...
number_of_broken_devices_and_type = (
1, 'EV')  # define number of devices to experience malfunctions and type (PV, EV, BESS, HP) during simulation
