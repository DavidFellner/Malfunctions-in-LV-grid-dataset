...
learning_config = {
    ...
    'setup_chosen' : {"phase1": {}, "phase2": {}},  # either 'all' for phase 1 setup A+B and phase 2 setup A+B or enter setups to be ommited such as: if phase 1, setup A should be omitted enter {"phase1": {"A"}, "phase2": {}} to omit the entire phase 1 enter {"phase1": {"A", "B"}, "phase2": {}}, if only class 'inversed' should be omitted for setup A enter {"phase1": {"A": ["inversed"]}, "phase2": {}}
    ...
    'real_vs': 'est' #est, sim; form negative samples either using the original sim data or the estimated one
}
